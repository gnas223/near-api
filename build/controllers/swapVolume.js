...
const get5mSwapVolume = (req, res, next) => {
    const pool_id = req.params.pool_id;
    swapVolume_1.default.find({ pool_id: Number(pool_id) }).sort({ createdAt: -1 }).limit(96)
        .then((volume) => res.status(200).json(volume.reverse()))
        .catch(next);
};
const updateNewSwapVolume = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let latestVolume = yield swapVolume_1.default.find({ pool_id }).sort({ createdAt: -1 }).limit(1);
    if (latestVolume.length > 0) {
        ...
        swapVolume_1.default.findOneAndUpdate({ pool_id }, { volume: { [tokenId1]: token1Volume.toString(), [tokenId2]: token2Volume.toString() }, volume_dollar }, { sort: { createdAt: -1 } })
            .then((volume) => res.status(200).json(volume))
            .catch(next);
    }
});
// get 15 minutes for each
const get15mSwapVolume = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const pool_id = req.params.pool_id;
    const _288Volume = yield swapVolume_1.default.find({ pool_id: Number(pool_id) }).sort({ createdAt: -1 }).limit(288);
...
const get30mSwapVolume = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const pool_id = req.params.pool_id;
    const _240Volume = yield swapVolume_1.default.find({ pool_id: Number(pool_id) }).sort({ createdAt: -1 }).limit(240);
    function groupArr(data, n) {
        let group = [];
        for (let i = 0, j = 0; i < data.length; i++) {
            if (i >= n && i % n === 0)
...
const get1hSwapVolume = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const pool_id = req.params.pool_id;
    const _576Volume = yield swapVolume_1.default.find({ pool_id: Number(pool_id) }).sort({ createdAt: -1 }).limit(576);
    function groupArr(data, n) {
        let group = [];
        for (let i = 0, j = 0; i < data.length; i++) {
            if (i >= n && i % n === 0)
...
const get4hSwapVolume = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const pool_id = req.params.pool_id;
    const _2016Volume = yield swapVolume_1.default.find({ pool_id: Number(pool_id) }).sort({ createdAt: -1 }).limit(2016);
    function groupArr(data, n) {
        let group = [];
        for (let i = 0, j = 0; i < data.length; i++) {
            if (i >= n && i % n === 0)
...
const get1daySwapVolume = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const pool_id = req.params.pool_id;
    const _4032Volume = yield swapVolume_1.default.find({ pool_id: Number(pool_id) }).sort({ createdAt: -1 }).limit(4032);
    function groupArr(data, n) {
        let group = [];
        for (let i = 0, j = 0; i < data.length; i++) {
            if (i >= n && i % n === 0)
...
const get4daysSwapVolume = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const pool_id = req.params.pool_id;
    const _17280Volume = yield swapVolume_1.default.find({ pool_id: Number(pool_id) }).sort({ createdAt: -1 }).limit(17280);
    function groupArr(data, n) {
        let group = [];
        for (let i = 0, j = 0; i < data.length; i++) {
            if (i >= n && i % n === 0)
...
const get7daysSwapVolume = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const pool_id = req.params.pool_id;
    const _30240Volume = yield swapVolume_1.default.find({ pool_id: Number(pool_id) }).sort({ createdAt: -1 }).limit(30240);
    function groupArr(data, n) {
        let group = [];
        for (let i = 0, j = 0; i < data.length; i++) {
            if (i >= n && i % n === 0)
...
const deleteAll = (req, res, next) => {
    swapVolume_1.default.deleteMany({})
        .exec()
...
//# sourceMappingURL=swapVolume.js.map